...
class SciTail(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('/home/tangpw/DecomposedPromptTuning/scitail.py', "snli_format", split=split)
...
class QNLI(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('/home/tangpw/DecomposedPromptTuning/glue.py', 'qnli', split=split)
