...
class Squad(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('/home/tangpw/DecomposedPromptTuning/lucadiliello___parquet/squad', split=split)
...
class NaturalQuestions(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('/home/tangpw/DecomposedPromptTuning/lucadiliello___naturalquestionsshortqa', split=split)
...
class HotpotQA(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('/home/tangpw/DecomposedPromptTuning/lucadiliello___parquet/lucadiliello--hotpotqa-30f778f57eac9663', split=split)
...
class SearchQA(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('/home/tangpw/DecomposedPromptTuning/lucadiliello___parquet/lucadiliello--searchqa-fa62df30d51c2886', split=split)
...
class SciTail(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('/data/nas/tangpwei/Adept/scitail.py', "snli_format", split=split)
...
class COLA(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('glue', 'cola', split=split, cache_dir="/home/tangpw/DecomposedPromptTuning/data/glue")
...
class QNLI(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('/data/nas/tangpwei/Adept/src/glue.py', 'qnli', split=split)
...
class SuperGLUEBoolQ(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('/data/nas/tangpwei/Adept/super_glue.py', 'boolq', split=split)
...
class SuperGLUEMultiRC(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('/data/nas/tangpwei/Adept/super_glue.py', 'multirc', split=split)
...
class WinoGrande(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('/home/tangpw/DecomposedPromptTuning/winogrande.py', "winogrande_xl", split=split)
...
class PAWS(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('/home/tangpw/DecomposedPromptTuning/paws.py', 'labeled_final', split=split)
