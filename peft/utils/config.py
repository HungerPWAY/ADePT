...
class PeftType(str, enum.Enum):
    ...
    PROMPT_TUNING_ab = "PROMPT_TUNING_ab"
    PROMPT_TUNING_LORAX = "PROMPT_TUNING_LORAX"
    PROMPT_TUNING_LORAXAB = "PROMPT_TUNING_LORAXAB"
    PROMPT_TUNING_LORAXL = "PROMPT_TUNING_LORAXL"
