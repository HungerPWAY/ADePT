...
@dataclass
class PromptTuningabConfig(PromptLearningConfig):
    """
...
class PromptEmbeddingab(torch.nn.Module):
    """
    ...
    **Attributes**:
    ...
    def __init__(self, config, word_embeddings):
        ...
        #self.a = nn.Parameter(torch.ones(config.max_length), requires_grad=True)
        #self.embedding_b = nn.Parameter(torch.zeros(config.token_dim), requires_grad=True)
